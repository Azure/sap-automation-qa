...
CONSTRAINTS = {
    "rsc_colocation": {
        "score": "4000",
        "rsc": lambda context: f"g_ip_{context.sid}_HDB{context.instance_number}",
        "rsc-role": "Started",
        "with-rsc": lambda context: f"msl_SAPHana_{context.sid}_HDB{context.instance_number}",
        "with-rsc-role": "Master",
    },
    "rsc_order": {
        "kind": "Optional",
        "first": lambda context: f"cln_SAPHanaTopology_{context.sid}_HDB{context.instance_number}",
        "then": lambda context: f"msl_SAPHana_{context.sid}_HDB{context.instance_number}",
    },
    "rsc_location": {
